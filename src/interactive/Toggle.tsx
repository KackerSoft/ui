...
//   ToggleSize,
//   { thumb: string; thumbTranslateY?: string }
// > = {
//   sm: {
//     thumb: "w-4",
//   },
...
//   accent: "bg-accent-500 border-accent-800",
...
//   const trackBase =
//     "relative inline-block w-full rounded-full transition-colors duration-200 ease-in-out border";
...
//         className={cn(
//           trackBase,
//           currentChecked ? checkedTrackBg : "bg-transparent border-gray-500/50 p-1",
//         )}
//       >
//         {/* thumb */}
//         <span
//           className={cn(
//             "transition-all bg-white rounded-full aspect-square",
//             styles.thumb,
//             currentChecked && "ml-2"
//           )}
//         />
